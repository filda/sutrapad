...
const DEFERRED_FROM_MUTATION: Readonly<Record<string, string>> = {
  ...
  "src/app/render-callbacks.ts": "glue; needs a focused test first",
  "src/app/render-helpers.ts": "glue; needs a focused test first",
  "src/app/state-store.ts": "atom store; needs a focused test first",
  ...
  "src/app/view/pages/capture-page.ts": "no dedicated test yet",
  ...
  "src/app/view/pages/tags-page.ts": "no dedicated test yet",
  "src/app/view/pages/terms-page.ts": "static copy page; no dedicated test yet",
  "src/app/view/chrome/account-bar.ts": "no dedicated test yet",
  "src/app/view/chrome/site-footer.ts": "no dedicated test yet",
  "src/app/view/chrome/static-page-shell.ts": "no dedicated test yet",
  "src/app/view/chrome/tag-filter-bar.ts": "no dedicated test yet",
  "src/app/view/chrome/topbar.ts": "no dedicated test yet",
  "src/app/view/shared/editor-sidebar.ts": "no dedicated test yet",
  "src/app/view/shared/empty-state.ts": "no dedicated test yet",
